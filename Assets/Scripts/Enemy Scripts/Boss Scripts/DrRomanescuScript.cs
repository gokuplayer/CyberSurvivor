...
public class DrRomanescuScript : MonoBehaviour
{
    ...
    void Start()
    {
        EnemyName = "Dr. Viktor Romanescu";
        MaxEHP = 22f * Target.gameObject.GetComponent<ICharacter>().CharacterLevel;
        EnemyHP = MaxEHP;
        EnemySpeed = 2.4f;
        EnemyAttack = Random.Range(22, 28);
        EnemyStatus = "None";
        EStatusMaxTime = 0.1f;
        gameManagerObject = GameObject.Find("Game Manager");

        dropCheck = Random.Range(0, 100);
        creditDropCheck = Random.Range(10, 80f);
