...
public class SniperElite : MonoBehaviour, ICharacter
{
    ...
    void Awake()
    {
        CharacterName = "Sniper Elite";

        CharacterMaxHP = 90;
        CharacterHP = CharacterMaxHP;
        CharacterSpeed = 5.5f;
        CharacterAttackPower = 1.3;
        CharacterHPRecovery = 0.0f;
        CharacterCritRate = 4.5f;
        ...
        StartingWeapon = "SniperSpawner";

        CharacterWeapons = new List<GameObject>();

        GameObject StartingWeaponObject = GameManager.GetComponent<GameManager>().AllWeapons[4];
