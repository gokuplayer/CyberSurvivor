...
public class Runner : MonoBehaviour, ICharacter
{
    ...
    void Awake()
    {
        ...
        CharacterSpeed = 7.0f;
        CharacterAttackPower = 0.9;
        CharacterHPRecovery = 0.0f;
        CharacterCritRate = 7.0f;
        ...
        StartingWeapon = "PistolSpawner";

        CharacterWeapons = new List<GameObject>();

        GameObject StartingWeaponObject = GameManager.GetComponent<GameManager>().AllWeapons[1];
