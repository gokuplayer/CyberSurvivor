...
public class Smasher : MonoBehaviour, ICharacter
{
    ...
    void Awake()
    {
        CharacterName = "Smasher";

        CharacterMaxHP = 120;
        CharacterHP = CharacterMaxHP;
        CharacterSpeed = 4.0f;
        CharacterAttackPower = 1.5;
        CharacterHPRecovery = 0.2f;
        CharacterCritRate = 4.0f;
        ...
        StartingWeapon = "MinigunSpawner";

        CharacterWeapons = new List<GameObject>();

        GameObject StartingWeaponObject = GameManager.GetComponent<GameManager>().AllWeapons[2];
