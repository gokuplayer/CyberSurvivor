...
public class Samurai : MonoBehaviour, ICharacter
{
    ...
    void Awake()
    {
        ...
        CharacterSpeed = 6.0f;
        CharacterAttackPower = 1.0;
        CharacterHPRecovery = 0.0f;
        CharacterCritRate = 10.0f;
        ...
        StartingWeapon = "KatanaSpawner";

        CharacterWeapons = new List<GameObject>();

        GameObject StartingWeaponObject = GameManager.GetComponent<GameManager>().AllWeapons[3];
